...
public class RealEstate
{
	...
	public RealEstate(int id, int exchange_year, int exhange_month, int total_price,
			double square_price, double x_long, double y_lat, int building_type_id,
			int ground_type_id)
	{
		this.estate_id = id;
		this.estate_group = 1;
	...
	public RealEstate(int id, int estate_group, String estate_address, int exchange_year,
			int exchange_month, int total_price, double square_price, double total_area,
			String exchange_content, String building_type, double x_long, double y_lat,
			int county_id, int town_id, int ground_type_id, int building_type_id)
	{
